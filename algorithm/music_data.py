...
# music_data.py almacena datos constantes utilizados por representation.py. Este archivo no contiene código ejecutable

##############################
# Datos específicos de representación
##############################
BEATS_P_MEASURE = 4.0
MEASURES_P_MELODY = 4
# Nota: Las notas enteras y de treinta y dos podrían ser admitidas, pero no se utilizan debido a que las melodías son cortas
BEAT_VALUES = [2.0, 1.0, 0.5, 0.25]
...
NOTE_RANGE = ["C4", "C4#", "D4", "D4#", "E4", "F4", "F4#", "G4", "G4#", "A4", "A4#", "B4", "C5",
              ...
              "Rest", "Rest", "Rest", "Rest"]  # Rango de clave de sol

##############################
# Datos específicos de MIDI
##############################
MIDI_RANGE = ["C0", "C0#", "D0", "D0#", "E0", "F0", "F0#", "G0", "G0#", "A0", "A0#", "B0",
              ...
              "C9", "C9#", "D9", "D9#", "E9", "F9", "F9#", "G9"]  # Rango MIDI
...
NOTE_TO_MIDI = {'C0': 12, 'C0#': 13, 'D0': 14, 'D0#': 15, 'E0': 16, 'F0': 17, 'F0#': 18, 'G0': 19, 'G0#': 20, 'A0': 21, 'A0#': 22, 'B0': 23,
                ...
                'C9': 120, 'C9#': 121, 'D9': 122, 'D9#': 123, 'E9': 124, 'F9': 125, 'F9#': 126, 'G9': 127, 'Rest': 128}  # Conversión de nota a valor MIDI
...
# Conversión de valor MIDI a nota

##############################
# Escalas
##############################
# Actualmente se implementan todas las escalas mayores y menores admitidas por MIDI.
key_sig = ["Cb", "Gb", "Db", "Ab", "Eb", "Bb",
           "F", "C", "G", "D", "A", "E", "B", "F#", "C#"]

SCALES = {
    'major': {
        "Cb": ["B2", "C3#", "D3#", "E3", "F3#", "G3#", "A3#", "B3"],
    ...
    'minor': {
        "Cb": ["B2", "C3#", "D3", "E3", "F3#", "G3", "A3", "B3"],
        "Gb": ["F2#", "G2#", "A2", "B2", "C3#", "D3", "E3", "F3#"],
        "Db": ["C2#", "D2#", "E2", "F2#", "G2#", "A2", "B2", "C3#"],
        "Ab": ["A2", "B2", "C3", "D3", "E3", "F3", "G3", "A3"],
        "Eb": ["D2#", "E2", "F2", "G2", "A2", "A2#", "C3", "D3"],
        "Bb": ["A2#", "B2", "C3", "D3", "E3", "F3", "G3", "A3"],
        "F": ["F2", "G2", "G2#", "A2#", "C3", "C3#", "D3#", "F3"],
        "C": ["C2", "D2", "D2#", "F2", "G2", "G2#", "A2#", "C3"],
        "G": ["G2", "A2", "A2#", "C3", "D3", "D3#", "F3", "G3"],
        "D": ["D2", "E2", "F2", "G2", "A2", "A2#", "C3", "D3"],
        "A": ["A2", "B2", "C3", "D3", "E3", "F3", "G3", "A3"],
        "E": ["E2", "F2#", "G2", "A2", "B2", "C3", "D3", "E3"],
        "B": ["B2", "C3#", "D3", "E3", "F3#", "G3", "A3", "B3"],
        "F#": ["F2#", "G2#", "A2", "B2", "C3#", "D3", "E3", "F3#"],
        "C#": ["C2#", "D2#", "E2", "F2#", "G2#", "A2", "B2", "C3#"],
    }
}
